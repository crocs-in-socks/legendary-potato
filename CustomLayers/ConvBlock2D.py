...
class Duck_Conv2d_Block(nn.Module):
    def __init__(self,filters):
        self.bn1 = nn.BatchNorm3d(filters)
        self.wide = Widescope_Conv2d_Block(filters)
        self.mid = Midscope_Conv2d_Block(filters)
        
        self.res_1 = Resnet_Conv2d_Block(filters)
        
        self.res_2_1 = Resnet_Conv2d_Block(filters)
        self.res_2_2 = Resnet_Conv2d_Block(filters)

        self.res_3_1 = Resnet_Conv2d_Block(filters)
        self.res_3_2 = Resnet_Conv2d_Block(filters)
        self.res_3_3 = Resnet_Conv2d_Block(filters)

        self.sep = Seperated_Conv2d_Block(filters,size=6)
    ...
    def forward(self,x):
        ...
        out  = out_wide + out_mid + out_res_1 + out_res_2 + out_res_3
...
class Seperated_Conv2d_Block(nn.Module):
