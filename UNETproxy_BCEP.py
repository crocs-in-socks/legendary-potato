...
date = '06_12_2023'
encoder_type = f'UNETproxy_encoder_weightedBCEpretrain_withLRScheduler'
classifier_type = f'UNETproxy_classifier_weightedBCEpretrain_withLRScheduler'
projector_type = f'UNETproxy_projector_weightedBCEpretrain_withLRScheduler'
...
encoder.load_state_dict(torch.load('./ModelArchitecture/unet_wts_proxy.pth')['model_state_dict'], strict=False)
