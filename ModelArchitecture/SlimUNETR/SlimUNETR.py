...
from ModelArchitecture.SlimUNETR.Decoder import Decoder
from ModelArchitecture.SlimUNETR.Encoder import Encoder
...
class SlimUNETR(nn.Module):
    ...
    def forward(self, x):
        ...
        return torch.sigmoid(x), hidden_states_out
