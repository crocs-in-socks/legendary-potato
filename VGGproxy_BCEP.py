...
number_of_epochs = 50
date = '03_12_2023'
encoder_type = f'VGGproxy_encoder_weightedBCEpretrain_batch{batch_size}_fixed'
classifier_type = f'VGGproxy_classifier_weightedBCEpretrain_batch{batch_size}_fixed'
projector_type = f'VGGproxy_projector_weightedBCEpretrain_batch{batch_size}_fixed'

save_model_path = f'/mnt/70b9cd2d-ce8a-4b10-bb6d-96ae6a51130a/LabData/models_retrained/experiments/Dec03/batch{batch_size}/'
