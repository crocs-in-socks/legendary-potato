...
date = '07_12_2023'
encoder_type = f'VGGproxy_encoder_weightedBCEpretrain_withLRScheduler_noiseData'
classifier_type = f'VGGproxy_classifier_weightedBCEpretrain_withLRScheduler_noiseData'
projector_type = f'VGGproxy_projector_weightedBCEpretrain_withLRScheduler_noiseData'

save_model_path = f'/mnt/fd67a3c7-ac13-4329-bdbb-bdad39a33bf1/LabData/models_retrained/experiments/Dec07/'
